...
const WritingForm = ({ mode = 'create', initialValues = null, onSuccess, onCancel }) => {
	...
	useEffect(() => {
		if (mode === 'edit' && initialValues) {
			...
			setFormData({
				...
				contentImageUrl: initialValues.contentImageUrl || '',
				level: levelValue || '',
	...
	return (
		<div className="max-h-[70vh] overflow-y-auto pr-2">
			<form onSubmit={handleSubmit} className="space-y-4">
				...
				<div>
					<Label htmlFor="content">Content/Guidance</Label>
					<Textarea id="content" value={formData.content} onChange={(e) => setFormData(v => ({ ...v, content: e.target.value }))} rows={3} />
				</div>
				...
				<div>
					<Label htmlFor="contentImageUrl">Content Image URL</Label>
					<Input id="contentImageUrl" value={formData.contentImageUrl} onChange={(e) => setFormData(v => ({ ...v, contentImageUrl: e.target.value }))} placeholder="https://..." />
				</div>
