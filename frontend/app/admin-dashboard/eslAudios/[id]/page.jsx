...
export default function AdminEslAudioDetailPage() {
  ...
  const confirmDelete = async () => {
    try {
      await fetch(`${BASE_URL}/api/esl-audios/${params.id}`, { method: 'DELETE', credentials: 'include' })
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      {audio.pdf && (
        <div className="mb-4">
          ...
          <a href={audio.pdf} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-primary hover:underline">
      ...
      {audio.taskPdf && (
        <div className="mb-4">
          ...
          <a href={audio.taskPdf} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-primary hover:underline">
